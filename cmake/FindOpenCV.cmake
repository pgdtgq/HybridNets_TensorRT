...
find_library(OPENCV_DNN NAMES libopencv_dnn.so PATHS ${LIB_PATH}/lib/${OPENCV-VERSION} NO_DEFAULT_PATH)
...
find_library(OPENCV_VIDEOIO NAMES libopencv_videoio.so PATHS ${LIB_PATH}/lib/${OPENCV-VERSION} NO_DEFAULT_PATH)
...
set(OpenCV_LIBRARIES ${OPENCV_CORE} ${OPENCV_DNN}  ${OPENCV_HIGHGUI} ${OPENCV_IMGPROC} ${OPENCV_IMGCODECS} ${OPENCV_CUDAIMGPROC} ${OPENCV_OPTFLOW} ${OPENCV_VIDEO})

# 第一个参数即为外部find_package()函数的参数，后面的变量都有效时第一个参数对应的<UPPERCASED_NAME>_FOUND变量被置为true
find_package_handle_standard_args(OpenCV DEFAULT_MSG OPENCV_CORE OPENCV_DNN
                                  OPENCV_HIGHGUI OPENCV_IMGPROC OPENCV_VIDEO OPENCV_VIDEOIO
                                  OPENCV_OPTFLOW OPENCV_CUDAIMGPROC OPENCV_IMGCODECS)

# 设置外部使用的变量
if(OPENCV_FOUND)
    set(OpenCV_LIBRARIES ${OPENCV_OPTFLOW} ${OPENCV_VIDEO} ${OPENCV_VIDEOIO} ${OPENCV_CORE} ${OPENCV_DNN} ${OPENCV_HIGHGUI} ${OPENCV_IMGPROC} ${OPENCV_IMGCODECS} ${OPENCV_CUDAIMGPROC})
